...
const loadCars = () => {
  ...
  // create a mouseover mouseout for each car card
  ...
  $(".carCard").on("mouseout", function () {
    ...
    $(this).find(".carImage img").css ("border-top-right-radius", "0px")
    $(this).find(".carImage img").css("border-bottom-left-radius", "0px")
  });
