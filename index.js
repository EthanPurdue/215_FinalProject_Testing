...
const readContent = (event) => {
  ...
  infoBarContent = `This ${array[index].carYear} ${array[index].carMake} ${array[index].carModel} is a ${array[index].carColor} ${array[index].carType} with ${array[index].carMiles} miles on it, for a price of $${array[index].carPrice}. <br> 
